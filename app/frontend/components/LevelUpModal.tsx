    ...
    >
      <Animated.View style={[styles.backdrop, { opacity: backdropOpacity }]}>
        ...
        >
          ...
          {/* Titre */}
          <Animated.Text
            style={[styles.title, { transform: [{ translateY: titleSlide }] }]}
          >
            Niveau supérieur !
          </Animated.Text>
          ...
          <View style={styles.badgeWrapper}>
                ...
                <View
                  ...
                  style={[
                    styles.ringDot,
                    {
                      ...
                      backgroundColor:
                        i % 3 === 0 ? COLORS.badgeGold : COLORS.secondary,
                      opacity: i % 3 === 0 ? 1 : 0.4,
                    },
                  ]}
                />
            ...
            <Animated.View
              style={[
                ...
                {
                  transform: [
                    { scale: Animated.multiply(levelScale, levelPulse) },
                  ],
                },
              ]}
            >
