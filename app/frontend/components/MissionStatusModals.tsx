...
export default function MissionStatusModal({ visible, onClose, type, missionTitle, dateLimit }: MissionProps) {
          ...
          <LinearGradient colors={theme.bg} style={[styles.modalGradient, { borderColor: theme.border }]}>
            <View style={styles.container}>
              ...
              <View style={styles.contentArea}>
                ...
                {/* HIBOU POSITIONNÉ À L'INTÉRIEUR (SELON PROTOTYPE) */}
                ...
                <View style={styles.statusInfoBox}>
                    <Text style={[styles.mainText, { color: theme.title }]}>
                        {isSuccess ? "Félicitations, Sonia !" : "Dommage..."}
                    </Text>
                ...
                {isSuccess ? (
                  <View style={styles.dataContainer}>
                    ...
                    <View style={styles.rewardRow}>
                      <View style={styles.rewardCard}>
                         <CoinPrice price="+50" colors={["#FFD700", "#FFA500"]} iconSize={22} />
                         <Text style={styles.rewardLabel}>Coins</Text>
                      </View>
                      <RewardItem icon="flash" val="+100" label="XP" color="#4A90E2" />
                  ...
                  <View style={styles.dataContainer}>
                    ...
                    <View style={styles.recapInner}>
                        <RecapRow label="Mission :" value={missionTitle || "Ingénieur IA - Présentation"} />
                        <RecapRow label="Date limite :" value={dateLimit || "01/12/2026"} />
...
const styles = StyleSheet.create({
  ...
  // NOUVEAU CONTENEUR HIBOU (À L'INTÉRIEUR)
  owlInsideContainer: { 
    width: '100%',
    alignItems: 'center',
    justifyContent: 'center',
    height: 140, // Espace réservé pour le hibou
    marginBottom: 10
  },
